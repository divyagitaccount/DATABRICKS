...
This folder defines all source code for the 'declarative pipeline' pipeline:
...
* Take a look at the sample under "sample_users_declarative_pipeline.py" to get familiar with the syntax.
